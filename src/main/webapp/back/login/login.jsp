...
<body <%--style="background: url(../login/img/16.jpg)no-repeat"--%>>
	
		<div class="login">
			<form id="loginForm" action="${pageContext.request.contextPath}/admin/findAllByUsername" method="post" >
					  ...
					  <tr>
						...
						<tr>
							...
							<td>
								...
								<a href="${pageContext.request.contextPath}/back/login/login.jsp" onclick="javascript:show();return false"><img id="AAAA" src="${pageContext.request.contextPath}/code/code"/></a><br/>
							</td>
						</tr>					
					<tr>
						<td>
