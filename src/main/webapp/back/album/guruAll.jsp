<%@page pageEncoding="UTF-8" contentType="text/html; UTF-8" isELIgnored="false" %>
    ...
    <script>
                    ...
                    {title:'options',field:'options',width:200,
                        formatter:function(value,row,index){
                            return "<a href='javascript:;' class='options' onclick=\"albumdelRow('"+row.id+"')\" data-options=\"iconCls:'icon-remove',plain:true\">删除</a>&nbsp;&nbsp;" +
                                "<a href='javascript:;' class='options' onclick=\"albumopenEditUserDialog('"+row.id+"')\" data-options=\"iconCls:'icon-edit',plain:true\">更新</a>";
                        }
                    }
                ]],
        ...
        //打开修改用户的对话框
        function albumopenEditUserDialog(id){
